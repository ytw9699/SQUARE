 ...
 <table width="600" border="0" cellspacing="0" cellpadding="2">
	<tr>
		<td align="center"><s:a href="dotChargeList.action?listOption=3"><h2>충전 통합 리스트</h2></s:a></td>
	</tr>
 </table>	
 ...
 <strong><s:a href="dotChargeList.action?listOption=3">&nbsp;&nbsp;전체 리스트&nbsp;</s:a><font color='black'><s:property value="dc_allCount"/></font></strong></td>
 
 <td align="left" width="300" >
 <strong><s:a href="dotChargeList.action?listOption=0">&nbsp;&nbsp;요청 리스트&nbsp;<font color='red'></s:a><s:property value="dc_chargingCount"/></font></strong></td>
 
 <td align="left" width="200" >
 <strong><s:a href="dotChargeList.action?listOption=1">완료 리스트&nbsp;<font color='green'></s:a><s:property value="dc_chargedCount"/></font></strong></td>
 
 <td align="left" width="200" align="right">
 <a href="dotExchangeList.action"/><strong>환전 리스트</strong></a>&nbsp;&nbsp;&nbsp;&nbsp;</td>
 
 <td align="left" width="900" >
 <strong>총 충전 완료량: <font color='red'><s:property value="sumCharge"/></font> DOT</strong></td>
 ...
 <%--<td><strong><s:property value="dc_num" />글번호</strong></td>--%>
 
 <td width="200"><strong>
 <a href='memberDetail.action?id=<s:property value="dc_id"/>'>아이디:&nbsp;</strong><s:property value="dc_id" /></a></td>
 
 <td width="800"><strong>요청날짜:&nbsp;</strong><fmt:formatDate value="${dc_date}" pattern="yy-MM-dd HH:mm" /></td>
 
 <td width="800"><strong>승인날짜:&nbsp;</strong><fmt:formatDate value="${dc_dated}" pattern="yy-MM-dd HH:mm" /></td>

 <td width="400"><strong>충전량:&nbsp;</strong><s:property value="dc_value" /> DOT</td>
 
 <td width="400">
 <s:if test="dc_status == 0"><font color='red'><strong>충전 대기중</strong></font></s:if>
 <s:if test="dc_status == 1"><font color='green'><strong>충전 완료</strong></font></s:if>
 </td>
 ...
 <s:if test="searchKeyword != NULL">
 <td><input name="취소2" input type="button" value="취소" class="inputb" onClick=
 ...
 <s:if test="searchKeyword == NULL">
 <td><input name="취소1" input type="button" value="취소" class="inputb" onClick=
