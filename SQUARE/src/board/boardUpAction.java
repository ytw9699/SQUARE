...
public class boardUpAction extends ActionSupport implements SessionAware{
	...
	public String execute() throws Exception{
		...
		upClass.setBoard_num(board_num); //�۹�ȣ �־��ֱ�
		upClass.setDo_date(today.getTime()); //��¥ �־��ֱ�
		upClass.setId(currentID); //���̵� �־��ֱ�
		
		//up�ִ��� ã��  and id
		int num= (Integer)sqlMapper.queryForObject("selectUp",upClass);//불러오질못함 이거 테이블없음
