...
public class memberArticles_pagingAction {
...
public memberArticles_pagingAction(int currentPage, int totalCount, int blockCount,
		int blockPage, int searchNum, String isSearch, String board_author)
{// 페이징 생성자
...
{
	if(isSearch != "") {
	pagingHtml.append("<a href=memberArticles.action?currentPage=1&board_author="+board_author+"&searchKeyword="+isSearch+"&searchNum="+searchNum+">");
	pagingHtml.append("<strong>처음</strong>");//첫페이지
	pagingHtml.append("</a>");
	pagingHtml.append("&nbsp;&nbsp;");
	}else {
	pagingHtml.append("<a href=memberArticles.action?currentPage=1&board_author="+board_author+">");
	pagingHtml.append("<strong>처음</strong>");//첫페이지
	pagingHtml.append("</a>");
	pagingHtml.append("&nbsp;&nbsp;");
	}
	...
	if(isSearch != "") {
		pagingHtml.append("<a href=memberArticles.action?currentPage=" + (startPage - 1) + "&board_author="+board_author+"&searchKeyword="+isSearch+"&searchNum="+searchNum+">");
	}else {
		pagingHtml.append("<a href=memberArticles.action?board_author="+board_author+"&currentPage=" + (startPage - 1) + ">");
	}
	...
	pagingHtml.append("</a>");
		...
		for (int i = startPage; i <= endPage; i++) {
			...
			if (i == currentPage) {
				...
				{
					pagingHtml.append("&nbsp;<a href='memberArticles.action?board_author="+board_author+"&currentPage=");
					pagingHtml.append(i);
					if(isSearch != "")
